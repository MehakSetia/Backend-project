...
id: serial("id").primaryKey(),
userId: integer("user\_id").notNull(),
hostId: integer("host\_id").notNull(),
title: text("title").notNull(),
startDate: text("start\_date").notNull(),
endDate: text("end\_date").notNull(),
...
id: serial("id").primaryKey(),
destinationId: text("destination\_id").notNull(),
name: text("name").notNull(),
